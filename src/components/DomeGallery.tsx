...
const TECH_STACK_IMAGES: ImageItem[] = [
  { src: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg', alt: 'Python' },
  { src: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg', alt: 'Java' },
  { src: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/c/c-original.svg', alt: 'C' },
  { src: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg', alt: 'HTML/CSS' },
  ...
  { src: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tensorflow/tensorflow-original.svg', alt: 'Generative AI' },
  { src: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linux/linux-original.svg', alt: 'Information Security' }
];
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              backgroundImage: `radial-gradient(rgba(235, 235, 235, 0) 85%, transparent 100%)` 
            }}
          />
          ...
          <div
            className="absolute inset-0 m-auto z-[3] pointer-events-none"
            style={{
              WebkitMaskImage: `radial-gradient(rgba(235, 235, 235, 0) 90%, transparent 95%)`,
              maskImage: `radial-gradient(rgba(235, 235, 235, 0) 90%, transparent 95%)`,
              backdropFilter: 'none'
            }}
          />
